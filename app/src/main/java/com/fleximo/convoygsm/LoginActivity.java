...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if(mPasswordConfirmView.getText().toString().equals(mPasswordView.getText().toString())) {
            ...
            ed.putString(MainActivity.TEXT_PASSWORD, mPasswordConfirmView.getText().toString());
            ed.commit();
            finish();
        }
        else {
            Toast.makeText(this, getString(R.string.str_Login_ErrConfirm), Toast.LENGTH_SHORT).show();
        }
    }
